...
lista_alturas = []
registros = {"A":[],"B":[], "C":[], "D":[], "E":[]}
#outras formas de criar o dict acima:
#registros = dict.fromkeys({"A","B","C","D","E"},[])
#registros = {i:[] for i in {"A","B","C","D","E"}}
continua = True
while(continua):
...
if len(lista_alturas)>0:
    ...
    print("\nFaixa --- Percentual")
    for k in registros:
        print(f"{k} --- {(len(registros[k])/len(lista_alturas))*100}%")
print("\nPrograma encerrado.")